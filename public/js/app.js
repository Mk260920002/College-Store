...
function initAdmin(socket) {
  ...
  function renderItem(items) {
    var element = Object.values(items);
    return element.map(function (data) {
      return "\n      <p>".concat(data.item.P_name, " qty-").concat(data.qty, "</p>\n      ");
    }).join("");
  }
  function generateMarkup(orders) {
    return orders.map(function (order) {
      return "<tr class=\"table-brdr\">\n             <td class=\"table-brdr \">\n            <p class=\"mx-auto\">".concat(order._id, "</p>\n            <div>\n            ").concat(renderItem(order.items), "\n            </div>\n             </td>\n             <td class=\"table-brdr\">\n            <p>\u20B9").concat(order.totalPrice, "</p>\n             </td>\n             <td class=\"table-brdr\">\n            <p>").concat(order.customerId.name, "</p>\n             </td>\n             <td class=\"table-brdr\">\n            <p>").concat(order.address, "</p>\n             </td>\n             <td class=\"table-brdr\">\n             <div>\n          <form action=\"/admin/order/status\" method=\"POST\"> \n          <input type=\"hidden\" name=\"orderId\" value=\"").concat(order._id, "\"> \n\n               <select  name=\"status\" onchange=\"this.form.submit()\" \n               class=\"text-basic w-full p-2.5 bg-slate-400 text-white\">\n                 \n                 <option value=\"Order Placed\" ").concat(order.status == "Order Placed" ? "selected" : "", "\n                 >Order Placed</option>\n                 <option value=\"Preparing\" ").concat(order.status == "Preparing" ? "selected" : "", "\n                 >Preparing</option>\n                 <option value=\"Out for delivery\" ").concat(order.status == "Out for delivery" ? "selected" : "", "\n                 >Out for delivery</option>\n                 <option value=\"Delivered\" ").concat(order.status == "Delivered" ? "selected" : "", "\n                 >Delivered</option>\n               </select>\n               </form> \n             </div>\n             </td>\n             <td class=\"table-brdr\">\n            <p>").concat(moment__WEBPACK_IMPORTED_MODULE_0___default()(order.createdAt).format("hh:mm A DD-MM-YY"), "</p>\n             </td>\n             <td class=\"table-brdr\">\n            <p>").concat(order.phone, "</p>\n             </td>\n          </tr>");
    }).join("");
  }
...
function deleteCart(item) {
  axios__WEBPACK_IMPORTED_MODULE_3__["default"].post('./delete-cart', item).then(function (res) {
